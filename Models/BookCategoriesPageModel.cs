...
namespace Ionel_Maxian_lab2.Models
{
    public class BookCategoriesPageModel: PageModel
    {
        ...
        public void PopulateAssignedCategoryData(Ionel_Maxian_lab2Context context, Book book)
        {
        ...
        public void UpdateBookCategories(Ionel_Maxian_lab2Context context, string[] selectedCategories, Book bookToUpdate) 
        { 
