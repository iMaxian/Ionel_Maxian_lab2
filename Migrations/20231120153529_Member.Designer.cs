...
namespace Ionel_Maxian_lab2.Migrations
{
    ...
    [Migration("20231120153529_Member")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ionel_Maxian_lab2.Models.Borrowing", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Ionel_Maxian_lab2.Models.Member", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Ionel_Maxian_lab2.Models.Book", b =>
                {
                    b.HasOne("Ionel_Maxian_lab2.Models.Author", "Author")
                        .WithMany("Books")
                        .HasForeignKey("AuthorID");

                    b.HasOne("Ionel_Maxian_lab2.Models.Publisher", "Publisher")
                        .WithMany("Books")
            ...
            modelBuilder.Entity("Ionel_Maxian_lab2.Models.Borrowing", b =>
                {
                    b.HasOne("Ionel_Maxian_lab2.Models.Book", "Book")
                        .WithOne("Borrowing")
                        .HasForeignKey("Ionel_Maxian_lab2.Models.Borrowing", "BookID");

                    b.HasOne("Ionel_Maxian_lab2.Models.Member", "Member")
                        .WithMany("Borrowings")
